package com.jackson.lai.transactional.config;
 ...
 *
 * @author jackson
 * @date 2022年01月07日10:19:00
 */
@Configuration
@MapperScan(basePackages = {"com.jackson.lai.transactional.dao"}, sqlSessionTemplateRef = "transactionalSqlSessionTemplate")
